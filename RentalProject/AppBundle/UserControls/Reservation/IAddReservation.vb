...
Public Class IAddReservation
    ...
    Private Sub IAddReservation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Function insertToReserv()
        Dim reservEntity As New ModelReservation
        ...
        Try
            If EquipmentCollection.Items.Count > 0 Then
                ...
                id = EntityReservations.getInstance.Empruntnextid()
