...
Public Class IAddPerson
    ...
    Sub New(p As IPerson, r As IAddEmprunt)
                ...
                If CBStatut.Text <> "Étudiant" Then
                    If Not String.IsNullOrEmpty(TBDepartement.Text) And
                        ...
                        If String.IsNullOrEmpty(TBPoste.Text) Then
                            TBPoste.Text = 0
                        End If
                        ModelPerson.getInstance.addPerson(TBMatricule.Text, TBNom.Text, TBPrenom.Text, CBStatut.Text, TBDepartement.Text, TBService.Text, TBBureau.Text, TBTelephone.Text, TBPoste.Text, Email.Text)
                    Else MessageBox.Show("Veuillez Vérifier les informations")
                    End If
                Else
                    ModelPerson.getInstance.addPerson(TBMatricule.Text, TBNom.Text, TBPrenom.Text, CBStatut.Text, TBDepartement.Text, "", "", TBTelephone.Text, 0, Email.Text)
                End If
                Me.SendToBack()
            Else
